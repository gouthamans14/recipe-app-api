...
# to mock the behaiour of database

from psycopg2 import OperationalError as Psycopg2Error
# Possibilities of error when we connect to datase before it connects
from django.core.management import call_command
# helper function to simulate to call the command
from django.db.utils import OperationalError
# another exception thrown by the database
from django.test import SimpleTestCase  # to test
# we are providing the path of the wait_for_db method.


@patch("core.management.commands.wait_for_db.Command.check")
# Mocking the behaviour of all the check so we are passing
# # the entire test class there.
